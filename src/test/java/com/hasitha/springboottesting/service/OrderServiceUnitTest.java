package com.hasitha.springboottesting.service;

import com.hasitha.springboottesting.exceptions.OrderNotFoundException;
import com.hasitha.springboottesting.model.Order;
import com.hasitha.springboottesting.repository.OrderRepository;
...
public class OrderServiceUnitTest {
    ...
    /*create a mock object of the repository layer*/
    @Mock
    OrderRepository orderRepository;

    /*Below annotaion will inject above mock bean into service layer*/
    @InjectMocks
    ...
    public void testCreateOrder() {
        ...
        /*The below line  verifies that the method is called only once!*/
