package com.hasitha.springboottesting.controller;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.hasitha.springboottesting.model.Order;
import com.hasitha.springboottesting.service.OrderService;
...
public class OrderControllerUnitTest {
    ...
    /*
    * Convert our Pojo to a JSON string
    * */
    ...
    * andDo(print()): Print the result
      andExpect(): Setup expected results in various aspects
      like response body, response format, response status code and etc.
      ...
      Here, “$” means the response JSON root level
    * */
    @Test
